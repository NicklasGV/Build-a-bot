...
export class AuthService {
  ...
  // wrap storage behind an interface
  ...
  constructor(
    ...
    // only use window.sessionStorage in the browser
    if (isPlatformBrowser(this.platformId)) {
      this.storage = window.sessionStorage;
    } else {
      // stub implementation for non-browser
      this.storage = {
    ...
    // initialize currentUserSubject from (possibly stubbed) storage
